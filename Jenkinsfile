    ...
    stages {
        stage("Pipeline"){
            ...
            post{
                ...
                failure{
                    slackSend color: 'danger', message: "[Cristian] [${env.JOB_NAME}] [${BUILD_TAG}] Ejecucion fallida en stage [${getCurrentStage()}]", teamDomain: 'dipdevopsusac-tr94431', tokenCredentialId: 'token-slack'
                }
            }
        }
    }
