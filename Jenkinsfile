    ...
    stages {
        stage("Pipeline"){
            ...
            post{
                ...
                failure{
                    slackSend color: 'danger', message: "[Cristian] [${env.JOB_NAME}] [${BUILD_TAG}] Ejecucion fallida en stage [${LAST_STAGE_NAME}]", teamDomain: 'dipdevopsusac-tr94431', tokenCredentialId: 'token-slack'
                }
            }
        }
    }
